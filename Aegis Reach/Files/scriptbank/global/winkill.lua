-- Win Kill v7 by Necrym59
-- DESCRIPTION: A global behavior that will monitor when all enemies have been killed, level is won and changes to next or selected level.
