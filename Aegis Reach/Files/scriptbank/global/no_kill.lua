-- No_Kill v5 by Necrym59
-- DESCRIPTION: A global behavior allows to kill the player and/or add/deduct from a User Global if they kill a NPC of the designated type.
