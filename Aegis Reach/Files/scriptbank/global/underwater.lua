-- Underwater v5 by Necrym59
-- DESCRIPTION: A global behavior that will change to the designated LUT group and/or change to the designated water shader rgb values when player is submerged
