-- Checkpoint v2
-- DESCRIPTION: Plays <Sound0> when player enters this checkpoint zone.
-- DESCRIPTION: Removes the zone afterwards and restores the player to this location when the player dies.
