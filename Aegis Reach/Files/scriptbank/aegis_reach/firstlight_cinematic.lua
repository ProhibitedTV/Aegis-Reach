...
function firstlight_cinematic_main(e)
 ...
 if not cine.seen.ARRIVAL_PERIM and not cine.failed.ARRIVAL_PERIM and not cine.active and not cine.pending and not aegis.cinematic_request and g_Time-(fl.born or g_Time)>350 then fl_request_cinematic('ARRIVAL_PERIM') end
