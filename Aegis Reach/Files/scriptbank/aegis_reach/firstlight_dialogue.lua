...
local catalog={
 FL01_KES_001={speaker="KESTREL",text="Seven, Meridian Control missed two scheduled check-ins.",seconds=3.6},
 FL01_KES_002={speaker="KESTREL",text="Forty-two evacuees never reached orbit. Mira Sen is still missing.",seconds=4.6},
 FL01_KES_003={speaker="KESTREL",text="Mira's last burst: 'Northstar offline. Array waking.' Then a Warden transponder crossed Gate Zero-Seven.",seconds=6.2},
 FL01_KES_004={speaker="KESTREL",text="Restore Northstar. Recover the manifest. Find our people.",seconds=4.0},
 FL01_KES_005={speaker="KESTREL",text="You are down. I will hold above the shelf until you call.",seconds=4.0},
...
local function mission_radio_tick()
 ...
 if fl.evac_start and fl.evac_start>0 then
  ...
  if t>=54000 and not runtime.evac[3] then runtime.evac[3]=true;fl_dialogue('FL01_KES_014') end
