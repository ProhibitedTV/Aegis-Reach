...
--
-- The previous hard-replacement proved the ownership model but placed several
-- cameras only a few hundred MAX inches from an ~800 x 704 inch airframe and aimed
-- them away from the hull. In native MAX that read as terrain glitches rather than
-- flight footage. This edit deliberately makes the Kestrel the subject: chase,
-- formation and low LZ tracking views all look back toward the live airframe.
local opening={started=false,finished=false,start_ms=0,shot=0,ship_obj=nil,ship_entity=nil,lines={},logged_wait=false}

-- Ship-relative cameras are intentionally well outside the Broadwing envelope.
-- `look` is a local-space point on/near the airframe, not an outward sensor vector.
-- Fixed cameras can `trackship=true` so a security/LZ shot still contains the ship.
local SHOTS={
 {beat='ARRIVAL_NOSE',stop=2800,label='KSTL-01 FORWARD CHASE // LIVE',carrier='ship',off={520,280,-1350},look={0,90,-40},clear=120,roll=.14,fls=58,fle=50},
 {beat='ARRIVAL_PORT_FWD',stop=5600,label='KSTL-02 PORT FORMATION // LIVE',carrier='ship',off={-1250,240,-420},look={0,95,0},clear=100,roll=.16,fls=60,fle=54},
 {beat='ARRIVAL_ISR',stop=8400,label='KSTL-03 HIGH TRACK // LIVE',carrier='ship',off={0,1050,-850},look={0,70,0},clear=180,roll=.08,fls=66,fle=58},
 {beat='ARRIVAL_GATE',stop=11400,label='M12-GATE-02 // AUTO TRACK',carrier='world',x=-520,z=-10120,h=260,trackship=true,look={0,80,0},fls=72,fle=62},
 {beat='ARRIVAL_STBD',stop=14500,label='KSTL-04 STBD FORMATION // LIVE',carrier='ship',off={1250,220,-260},look={0,95,0},clear=100,roll=.18,fls=58,fle=52},
 {beat='ARRIVAL_TAIL',stop=17500,label='KSTL-05 REAR CHASE // LIVE',carrier='ship',off={0,300,1450},look={0,95,80},clear=120,roll=.18,fls=60,fle=52},
 {beat='ARRIVAL_CONVERT',stop=20500,label='KSTL-06 CONVERSION OBS // LIVE',carrier='ship',off={980,210,980},look={0,70,0},clear=100,roll=.12,fls=56,fle=48},
 {beat='ARRIVAL_BELLY',stop=23500,label='KSTL-07 LOWER PORT OBS // LIVE',carrier='ship',off={-920,-320,760},look={0,20,0},clear=70,roll=.08,fls=54,fle=46},
 {beat='ARRIVAL_GEAR',stop=26500,label='KSTL-08 GEAR OBS // LIVE',carrier='ship',off={820,-240,820},look={0,-25,0},clear=55,roll=.06,fls=52,fle=44},
 {beat='ARRIVAL_LZ',stop=29500,label='LZ07-PERIM-01 // AUTO TRACK',carrier='world',x=610,z=-9420,h=190,trackship=true,look={0,70,0},fls=68,fle=58},
 {beat='ARRIVAL_GEAR_CLOSE',stop=32500,label='KSTL-08 GEAR CLOSE // LIVE',carrier='ship',off={600,-150,610},look={0,-20,0},clear=45,roll=.05,fls=48,fle=42},
 {beat='ARRIVAL_TOUCHDOWN',stop=35500,label='LZ07-PAD-03 // AUTO TRACK',carrier='world',x=260,z=-9270,h=95,trackship=true,look={0,65,0},fls=62,fle=54},
 {beat='ARRIVAL_RAMP',stop=38500,label='KSTL-09 REAR RAMP OBS // LIVE',carrier='ship',off={0,190,1350},look={0,60,245},clear=80,roll=.06,fls=54,fle=48},
 {beat='ARRIVAL_DEPLOY',stop=42700,label='KSTL-10 PORT REAR OBS // DEPLOY',carrier='ship',off={-900,130,1100},look={0,60,230},clear=70,roll=.04,fls=52,fle=46},
 {beat='ARRIVAL_LIFTOFF',stop=45300,label='LZ07-LIFT CAM // AUTO TRACK',carrier='world',x=520,z=-9300,h=85,trackship=true,look={0,80,0},fls=62,fle=54},
 {beat='ARRIVAL_CLIMB',stop=47800,label='KSTL-11 PORT CHASE // CLIMB',carrier='ship',off={-1150,320,950},look={0,90,50},clear=120,roll=.16,fls=58,fle=50},
 {beat='ARRIVAL_DEPART',stop=50800,label='KSTL-12 LONG REAR CHASE // DEPART',carrier='ship',off={0,420,1850},look={0,110,80},clear=160,roll=.18,fls=64,fle=54},
}
...
local function tracked_ship_target(s)
 local sx,sy,sz,srx,sry,srz=ship_transform();if not sx then return nil end
 local look=s.look or {0,80,0};local lx,ly,lz=rotate_local(look[1],look[2],look[3],srx,sry,srz)
...
local function begin()
 ...
 log('begin Kestrel-subject 17-shot insertion')
end
