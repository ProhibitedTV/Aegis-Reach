...
function firstlight_director_main(e)
 ...
 -- Compact mission HUD. Space and landmarks carry navigation; HUD confirms it.
 Panel(1,1,44,14);Panel(72,1,99,14)
 ...
 TextColor(74,3,1,'SHIELD '..meter(fl.shield,10)..' '..math.floor(fl.shield),103,220,230)
 TextColor(74,8,1,'ARMOUR '..meter(fl.armour,10)..' '..math.floor(fl.armour),232,234,224)
