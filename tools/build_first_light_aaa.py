...
report.update({
 ...
 'cineguru_native_chain':cineguru_chain,'biosphere':biosphere,'title_screen_convergence':title_screen,
...
print('Native CineGuru opener chain:',cineguru_chain['native_chain'],'//',cineguru_chain['camera_count'],'linked cameras')
