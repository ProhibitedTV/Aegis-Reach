...
LINES=(
 dict(id='FL01_KES_001',speaker='KESTREL',filename='fl01_kestrel_001.wav',seconds=3.6,direction='controlled insertion briefing; professional, low urgency',text='Seven, Meridian Control missed two scheduled check-ins.'),
 dict(id='FL01_KES_002',speaker='KESTREL',filename='fl01_kestrel_002.wav',seconds=4.6,direction='human stakes; restrained concern',text='Forty-two evacuees never reached orbit. Mira Sen is still missing.'),
 dict(id='FL01_KES_003',speaker='KESTREL',filename='fl01_kestrel_003.wav',seconds=6.2,direction='recount corrupted evidence; measured',text="Mira's last burst: 'Northstar offline. Array waking.' Then a Warden transponder crossed Gate Zero-Seven."),
 dict(id='FL01_KES_004',speaker='KESTREL',filename='fl01_kestrel_004.wav',seconds=4.0,direction='mission order; decisive',text='Restore Northstar. Recover the manifest. Find our people.'),
 dict(id='FL01_KES_005',speaker='KESTREL',filename='fl01_kestrel_005.wav',seconds=4.0,direction='touchdown handoff; calm confidence',text='You are down. I will hold above the shelf until you call.'),
